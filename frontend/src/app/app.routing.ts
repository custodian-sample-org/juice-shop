...
export function tokenMatcher (url: UrlSegment[]): UrlMatchResult { // vuln-code-snippet neutral-line tokenSaleChallenge
  ...
  if (path.match(((10).toString(36).toLowerCase() + token2(13, 144, 87, 152, 139, 144, 83, 138) + (36669).toString(36).toLowerCase() + token1(25, 184, 174, 179, 182, 186)))) { // vuln-code-snippet vuln-line tokenSaleChallenge
